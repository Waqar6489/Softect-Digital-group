...
import {
  CheckCircle, Phone, Mail, Sparkles, Heart, Star, BarChart3, Target, Activity
} from 'lucide-react';
import { FaGoogle, FaInstagram, FaTiktok, FaPhoneAlt, FaBullhorn, FaSync, FaSitemap, FaTooth } from "react-icons/fa";
...
export default function DentalLandingPage() {
  ...
  const trustItems = [
    ...
    { name: "Healthy Teeth Clinic", icon: <Heart/> },
    { name: "Perfect Dental Care", icon: <Star/> },
    { name: "Smile Care Center", icon: "😊" },
    { name: "Elite Dental Studio", icon: <Target/> },
    { name: "Family Dental Clinics", icon: "👨‍👩‍👧" },
    { name: "Orthodontic Specialists", icon: "🦴" },
    { name: "Cosmetic Dentistry", icon: <Sparkles/> },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${apiBase}/api/dental-lead`, {
        method: 'POST',
      ...
      if (result.status === 'success') {
        ...
        setFormData({ name: '', email: '', phone: '', clinicName: '', dentalServices: '', message: ''});
    ...
    <div className="bg-gray-50 text-gray-900 font-sans antialiased">
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-7 space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tight leading-none text-[#122a52]">
            ...
            <span className="text-[#a442af]">More Revenue.</span>
          </h1>
          <p className="text-xl text-slate-700 font-medium max-w-2xl">
            Lead Generation Services for Dental Clinics & Dental Practices using Google Ads, Meta Ads, TikTok Ads & Cross-Channel Marketing.
          </p>

          <div className="space-y-3 pt-4">
            {[
              "Attract high-intent patients looking for dental treatments",
              "Increase appointment bookings and reduce empty chair time",
              "Generate more inquiries for implants, veneers, braces & cosmetic dentistry",
              "Maximize ROI with data-driven advertising campaigns",
        ...
        <div id='form' className="lg:col-span-5 border-4 border-[#a442af] rounded-2xl p-6 bg-white shadow-xl relative">
          <div className="text-center mb-6 pt-2">
            ...
            <h2 className="text-2xl font-black uppercase tracking-tight text-[#a442af]">Dental Patient Leads</h2>
          </div>
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: 'Clinic Name', id: 'clinicName', type: 'text' },
                  { label: 'Dental Services', id: 'dentalServices', type: 'text' },
                ].map((field) => (
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
          <div className="lg:col-span-5 p-8 lg:p-12 space-y-6">
            <h3 className="text-[#a442af] uppercase font-black tracking-tight text-lg">Helping Dental Clinics</h3>
            <h2 className="text-3xl font-black uppercase text-[#122a52] leading-tight">
              Attract More Patients. <span className="text-[#a442af]">Fill More Appointment Slots.</span>
            </h2>
            <p className="text-slate-600 font-medium">
              Softech helps dental clinics and practices generate high-quality patient leads through Google Ads, Meta Ads, TikTok Ads, and Cross-Channel Marketing campaigns.
            </p>
            <p className="text-slate-600 font-medium">
              Whether you offer dental implants, orthodontics, cosmetic dentistry, teeth whitening, veneers, or general dentistry, we help you reach patients actively searching for your services.
            </p>
          ...
          <div className="lg:col-span-7 relative h-full min-h-[450px]">
            <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1606811841689-23dfddce3e95?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')` }}>
            ...
            <div className="absolute bottom-6 right-6 left-6 md:left-auto md:w-96 bg-white p-6 rounded-2xl shadow-2xl border-t-4 border-[#a442af] space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-black uppercase tracking-tight text-sm text-[#122a52]">Helping Dental Clinics Get More Patients & Fill More Appointment Slots</h4>
              </div>
              <p className="text-xs text-slate-600 font-medium leading-relaxed">
                Reach patients actively searching for dental services and grow your practice with proven lead generation strategies. Increase bookings for implants, braces, cosmetic dentistry, veneers, teeth whitening, and general dental care.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center mb-8 flex items-center justify-center gap-4">
          ...
          <h2 className="text-2xl font-black uppercase tracking-tight text-[#122a52]">What Our Dental Clients Say</h2>
          <div className="hidden sm:block h-[2px] w-16 bg-[#a442af]"></div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          {[
            { quote: "Softech increased our patient inquiries by 63% in just 90 days. Our appointment calendar is now consistently full.", author: "Smile Dental Clinic" },
            { quote: "We saw a huge increase in implant consultation bookings through Google Ads.", author: "Advanced Dental Care" },
            { quote: "Professional team, transparent reporting, and outstanding lead quality.", author: "Bright Smile Dentistry" }
          ].map((t, idx) => (
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center mb-10 flex items-center justify-center gap-4">
          <div className="hidden sm:block h-[2px] w-16 bg-[#a442af]"></div>
          <h2 className="text-2xl font-black uppercase tracking-tight text-[#122a52]">Our Dental Lead Generation Services</h2>
          <div className="hidden sm:block h-[2px] w-16 bg-[#a442af]"></div>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 text-center">
          {[
            { label: "Google Ads for Dental Clinics", icon: <FaGoogle className="text-[#a442af] mx-auto" size={28} /> },
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm">
          <div className="text-center mb-8 flex items-center justify-center gap-4">
            <div className="hidden sm:block h-[2px] w-16 bg-[#a442af]"></div>
            <h2 className="text-2xl font-black uppercase tracking-tight text-[#122a52]">We Solve Dental Marketing Challenges</h2>
            <div className="hidden sm:block h-[2px] w-16 bg-[#a442af]"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
            {[
              "Low patient inquiries and appointment bookings",
              "High advertising costs with poor ROI",
              "Empty appointment slots and chair time",
              "Difficulty attracting high-value treatment patients",
              "Low visibility compared to competing clinics",
              "Poor website conversion rates",
              "Lack of lead tracking and reporting",
              "Inconsistent monthly patient flow"
            ].map((challenge, idx) => (
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 text-center">
        <style>{`
          @keyframes marquee-dental {
            0% { transform: translateX(0%); }
            100% { transform: translateX(-50%); }
          }
          .animate-marquee-dental {
            display: flex;
            width: max-content;
            animation: marquee-dental 32s linear infinite;
          }
          .animate-marquee-dental:hover {
            animation-play-state: paused;
          }
        `}</style>
        <h3 className="text-slate-800 uppercase font-black text-sm tracking-widest mb-6">
          Trusted By Dental Clinics & Practices
        </h3>
        <div className="relative w-full overflow-hidden py-2">
          <div className="animate-marquee-dental gap-6">
      ...
      <section className="max-w-7xl mx-auto px-4 pb-16">
        <div className="bg-[#a442af] text-white rounded-3xl p-8 md:p-12 text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-6 shadow-xl">
          <div className="space-y-2">
            <h2 className="text-2xl md:text-3xl font-black uppercase tracking-tight">READY TO GROW YOUR DENTAL PRACTICE?</h2>
            <p className="font-bold text-purple-100">Get More Patients. More Appointments. More Revenue. Book Your Free Dental Marketing Consultation Today.</p>
          </div>
      ...
      <footer className="bg-[#122a52] text-white text-xs py-4 px-4 font-medium">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-3 text-center">
          <div className="flex flex-wrap justify-center gap-2 md:gap-4 text-slate-300">
            <span className="font-bold text-white">🛡️ Dental Lead Generation Experts</span>
