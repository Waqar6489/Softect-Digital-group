...
import { CheckCircle, Phone, Mail, BookOpen, GraduationCap, BarChart3, Star } from 'lucide-react';
...
export default function EducationLandingPage() {
  ...
  const trustItems = [
    { name: "Tutoring Centers", icon: <BookOpen/> },
    { name: "Coaching Institutes", icon: "🎓" },
    { name: "Competitive Exam Training", icon: "📝" },
    { name: "Skill Development Academies", icon: "🛠️" },
    { name: "Online Learning Platforms", icon: "💻" },
    { name: "Language Training Centers", icon: "🗣️" },
    { name: "Test Prep Institutes", icon: "✏️" },
    { name: "Schools & Education Brands", icon: "🏫" },
  ];
  ...
  const [formData, setFormData] = useState({
    ...
    instituteName: '', coursesOffered: '', targetStudents: '', budget: '',
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${apiBase}/api/education-lead`, {
        method: 'POST',
      ...
      if (result.status === 'success') {
        ...
        setFormData({ name: '', email: '', phone: '', message: '', instituteName: '', coursesOffered: '', targetStudents: '', budget: '' });
        setStep(1);
    ...
    <div className="bg-gray-50 text-gray-900 font-sans antialiased">
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-7 space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tight leading-none text-[#122a52]">
            More Leads.<br />More Students.<br /><span className="text-[#a442af]">More Growth.</span>
          </h1>
          <p className="text-xl text-slate-700 font-medium max-w-2xl">
            Lead Generation Services for Education & Training (Tutoring, Coaching, Academies) Using Google Ads, Meta Ads, TikTok Ads & Cross-Channel Marketing.
          </p>
          <div className="space-y-3 pt-4">
            {["Attract high-quality student inquiries","Fill your classes & batches with ready-to-enroll students","Book more demo classes & counseling sessions","Maximize ROI with data-driven ad campaigns","Real-time tracking, reporting & optimization"].map((text, idx) => (
        ...
        <div id='form' className="lg:col-span-5 border-4 border-[#a442af] rounded-2xl p-6 bg-white shadow-xl">
          <div className="text-center mb-6 pt-2">
            ...
            <h2 className="text-2xl font-black uppercase tracking-tight text-[#a442af]">Student Leads</h2>
          </div>
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            ...
            {step === 2 && (
              <div className="space-y-4">
                {[
                  {label:'Institute Name',id:'instituteName',type:'text'},
                  {label:'Courses Offered',id:'coursesOffered',type:'text'},
                  {label:'Target Students',id:'targetStudents',type:'text',placeholder:'e.g., Class 10, IIT, NEET, Spoken English'},
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
          <div className="lg:col-span-5 p-8 lg:p-12 space-y-6">
            <h3 className="text-[#a442af] uppercase font-black tracking-tight text-lg">Helping Education & Training Institutes</h3>
            <h2 className="text-3xl font-black uppercase text-[#122a52] leading-tight">Get More Enrollments, More Batches, <span className="text-[#a442af]">More Success.</span></h2>
            <p className="text-slate-600 font-medium">We help tutoring centers, coaching institutes and academies generate qualified student leads through Google Ads, Meta Ads, TikTok Ads, and cross-channel strategies.</p>
            <p className="text-slate-600 font-medium">Whether you offer academic coaching, entrance exam prep, skill development or online classes — we run performance marketing campaigns that bring you real inquiries and admissions.</p>
          ...
          <div className="lg:col-span-7 relative h-full min-h-[450px]">
            <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?q=80&w=1200&auto=format&fit=crop')` }}>
            ...
            <div className="absolute bottom-6 right-6 left-6 md:left-auto md:w-96 bg-white p-6 rounded-2xl shadow-2xl border-t-4 border-[#a442af] space-y-3">
              <div className="flex items-center gap-2">
                <div className="bg-[#a442af] text-white p-2 rounded-full"><GraduationCap size={18} /></div>
                <h4 className="font-black uppercase tracking-tight text-sm text-[#122a52]">Delivering Student Leads That Convert into Admissions</h4>
              </div>
              <p className="text-xs text-slate-600 font-medium leading-relaxed">We deliver high-intent student inquiries that convert into demo bookings, counseling sessions and admissions — helping you grow enrollments, batch strength and long-term student success.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { quote: "Softech helped us fill our batches consistently. Quality leads and demo bookings have increased significantly.", author: "Bright Future Academy" },
            { quote: "We run ads for JEE & NEET. The inquiries we get are highly relevant and convert well.", author: "Vertex Classes" },
            { quote: "Transparent reporting and excellent communication. Our admissions have grown every month.", author: "Scholar's Point" }
          ].map((t, idx) => (
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center mb-10 flex items-center justify-center gap-4">
          <div className="hidden sm:block h-[2px] w-16 bg-[#a442af]"></div>
          <h2 className="text-2xl font-black uppercase tracking-tight text-[#122a52]">Our Student Lead Generation Services</h2>
          <div className="hidden sm:block h-[2px] w-16 bg-[#a442af]"></div>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 text-center">
          {[
            { label: "Google Ads for Education", icon: <FaGoogle className="text-[#a442af] mx-auto" size={28} /> },
            ...
            { label: "LinkedIn Ads for Institutes", icon: <FaLinkedinIn className="text-[#a442af] mx-auto" size={24} /> },
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm">
          <div className="text-center mb-8 flex items-center justify-center gap-4">
            <div className="hidden sm:block h-[2px] w-16 bg-[#a442af]"></div>
            <h2 className="text-2xl font-black uppercase tracking-tight text-[#122a52]">We Solve Education & Training Institutes' Growth Challenges</h2>
            <div className="hidden sm:block h-[2px] w-16 bg-[#a442af]"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
            {["Low website traffic & inquiries","High cost per lead & low demo bookings","Irregular batch enrollments","Low attendance in demo classes","High competition & ad saturation","Unpredictable lead flow","Lack of follow-ups & student nurturing","Difficulty in tracking ROI"].map((c, idx) => (
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 text-center">
        <style>{`@keyframes mq-ed{0%{transform:translateX(0%)}100%{transform:translateX(-50%)}}.mq-ed{display:flex;width:max-content;animation:mq-ed 32s linear infinite}.mq-ed:hover{animation-play-state:paused}`}</style>
        <h3 className="text-slate-800 uppercase font-black text-sm tracking-widest mb-6">Trusted By Education & Training Institutes</h3>
        <div className="relative w-full overflow-hidden py-2">
          <div className="mq-ed gap-6">
      ...
      <section className="max-w-7xl mx-auto px-4 pb-16">
        <div className="bg-[#a442af] text-white rounded-3xl p-8 md:p-12 text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-6 shadow-xl">
          <div className="space-y-2">
            <h2 className="text-2xl md:text-3xl font-black uppercase tracking-tight">READY TO GROW YOUR STUDENT ENROLLMENTS?</h2>
            <p className="font-bold text-purple-100">More Qualified Leads. More Enrollments. More Success for Your Institute.</p>
          </div>
